...
<div id="loginModal" class="modal-overlay">
    ...
    <section class="about-section">
      ...
      <div class="mission-vision">
        <div class="mission">
          ...
          <p>
            Kami menghadirkan pendidikan yang bermutu tinggi dengan mengedepankan pengembangan potensi siswa secara akademik maupun non-akademik, serta menanamkan nilai-nilai integritas, etika, dan semangat kebangsaan demi membentuk pribadi
            yang unggul dan bertanggung jawab.
          </p>
        </div>
        <div class="vision">
          <h3><i class="fas fa-eye"></i> Visi Kami</h3>
          <p>SMA 01 Elite Harapan Bangsa berkomitmen menjadi sekolah unggulan yang mencetak generasi muda yang cerdas secara intelektual, kuat dalam karakter, dan siap bersaing di era global.</p>
        </div>
      </div>
    </section>
    ...
    <section class="cta-section">
      <div class="cta-content">
        <h2>Mau Menjadi Bagian Dari Kami?</h2>
        <p>Dapatkan Fasilitas lengkap, Terbaik se Indonesia</p>
        <a href="../../Page/pendaftaran/index.php" class="cta-button">Daftar Sekarang</a>
      </div>
    </section>
