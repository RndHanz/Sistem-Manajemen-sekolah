    ...
    <main class="section-padding" style="margin-top: 100px">
      <div class="container">
        ...
        <div class="blog-image" style="margin-bottom: 30px">
          <img src="https://images.unsplash.com/photo-1522202176988-66273c2fd55f?ixlib=rb-1.2.1&auto=format&fit=crop&w=1351&q=80" alt="Belajar Matematika" style="width: 100%; border-radius: 12px" />
        </div>
        <h2 class="section-title">Pentingnya Pendidikan Karakter di Sekolah</h2>
        <p class="news-date">25 Mei 2023 | Pak Agus - Kepala Sekolah</p>
        <p style="margin-top: 20px">
          Di era modern ini, keberhasilan pendidikan tidak hanya diukur dari prestasi akademik siswa, tetapi juga dari bagaimana mereka mampu menjadi pribadi yang berakhlak mulia, bertanggung jawab, dan peduli terhadap lingkungan sekitar.
        </p>
        <p style="margin-top: 15px">
          Pendidikan karakter memainkan peran penting dalam membentuk kepribadian siswa. Nilai-nilai seperti kejujuran, disiplin, kerja sama, dan empati harus ditanamkan sejak dini, baik melalui pelajaran di kelas maupun kegiatan di luar
          akademik.
        </p>
        <p style="margin-top: 15px">
          Di sekolah kami, kami mendorong siswa untuk aktif dalam kegiatan sosial, organisasi, dan kepemimpinan sebagai bagian dari proses pembentukan karakter. Kegiatan seperti bakti sosial, pramuka, dan upacara rutin bukan hanya kegiatan
          seremonial, tetapi juga sarana pendidikan nilai-nilai luhur.
        </p>
        <p style="margin-top: 15px">
          Peran guru dan orang tua sangat penting dalam membimbing dan memberi teladan. Anak-anak belajar bukan hanya dari apa yang diajarkan, tetapi dari apa yang mereka lihat dan rasakan dari orang-orang di sekitarnya.
        </p>
        <p style="margin-top: 15px">
          Dengan mengedepankan pendidikan karakter, kita berharap bisa mencetak generasi muda yang tidak hanya cerdas secara intelektual, tetapi juga memiliki integritas dan mampu memberikan kontribusi positif bagi masyarakat dan bangsa.
        </p>
      </div>
    </main>
